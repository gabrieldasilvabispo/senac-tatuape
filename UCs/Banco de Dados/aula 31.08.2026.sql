...
/* vinculando o estudante 5 ao curso 2 */
...
/* inner join so traz quem esta ligados */
select estudantes.nome, cursos.nome, cursos.ano from estudantes
inner join cursos
on cursos.idcurso = estudantes.cursoprefere;

/* Apelido para as tabelas: cursos é c e estudantes é e*/
/*inner join somente o que é relacionado*/
...
/*Left join lista tambem quem não faz cursos */
select e.nome, c.nome, c.ano 
from estudantes as e
...
/* Right e right outer */
select e.nome, c.nome, c.ano 
from estudantes as e right join cursos as c
on c.idcurso = e.cursoprefere
order by e.nome;

select e.nome, c.nome, c.ano 
from estudantes as e right outer join cursos as c
on c.idcurso = e.cursoprefere
order by e.nome;
...
(default, '2026-08-20', 2, 5),
(default, '2026-08-15', 3, 10),
(default, '2026-08-18', 4, 25);
